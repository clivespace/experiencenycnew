 ...
 * 
 * Usage:
 * <img src="/api/image-proxy/image?url=https://example.com/image.jpg" alt="Example" />
 * 
 * Security notes:
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Handle Unsplash URLs directly if they're detected
    if (imageUrl.includes('images.unsplash.com')) {
      // For Unsplash images, ensure proper format that includes width
